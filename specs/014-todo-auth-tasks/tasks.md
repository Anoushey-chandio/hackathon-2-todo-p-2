---
description: "Task list for Full-Stack Todo App Auth and Tasks"
---

# Tasks: Full-Stack Todo App Auth and Tasks

**Input**: Design documents from `/specs/014-todo-auth-tasks/`
**Prerequisites**: plan.md (required), spec.md (required), research.md, data-model.md, contracts/

**Tests**: Integration tests included for critical flows (Auth, CRUD).
...
## Phase 3: User Story 1 - Secure User Onboarding & Access (Priority: P1)
...
- [x] T012 [US1] Generate Alembic migration for User table in `backend/migrations/versions/`
...
- [x] T018 [US1] Create Dashboard Page (Protected) in `frontend/src/app/(dashboard)/page.tsx`
- [x] T019 [US1] Implement Auth Middleware in `frontend/src/middleware.ts` for Route Protection
...
- [x] T021 [US2] Generate Alembic migration for Task table in `backend/migrations/versions/`
...
- [x] T024 [US2] Update Frontend Dashboard to display Task List in `frontend/src/app/(dashboard)/page.tsx`
...
## Phase 5: User Story 3 - Data Privacy & Error Handling (Priority: P2)

**Goal**: Clear error messages and strict data privacy.

**Independent Test**: Visual inspection of error states and cross-user data isolation verification.

- [x] T028 [US3] Add Permission Checks (Owner Only) in `backend/src/api/endpoints/tasks.py`
- [x] T029 [US3] Implement Global Error Handling in Frontend `frontend/src/components/ui/toast.tsx` (or similar)
- [x] T030 [US3] Verify Data Isolation via Test Script `backend/tests/test_isolation.py`

## Phase 6: Polish & Cross-Cutting Concerns

**Purpose**: Improvements that affect multiple user stories

- [x] T031 [P] Verify API Security (CORS, Rate Limiting) in `backend/src/main.py`
- [x] T032 [P] Update `README.md` with setup instructions
- [x] T033 [P] Final End-to-End Test Run
...
- **User Story 3 (P2)**: Can run parallel to US2, but best after US2
...
4. Validate Isolation (US3) -> Polish
